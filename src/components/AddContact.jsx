...
const ContactForm = () => {
    ...
    const handleSubmit = async e => {
        ...
        try {
            const response = await fetch("https://playground.4geeks.com/contact/agendas/Jonathan/contacts", {
                method: "POST",
            ...
            setForm({ name: "", email: "", phone: "", address: "", agenda_slug: "Jonathan" });
            navigate("/");
        } catch (error) {
